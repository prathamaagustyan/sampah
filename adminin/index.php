...
if(isset($_SESSION['username'])){ // Jika session username ada berarti dia sudah login
	header('location: beranda'); // Kita Redirect ke halaman beranda.php
}
?>
  ...
  <br>
    <div class="flex-column">
      ...
      <div class="inputForm">
        ...
        <input type="text" name="username" class="input" placeholder="Masukkan email">
      </div>
    ...
    <p class="p">Don't have an account? <span class="span"><a href="daftar">Sign Up</a></span>
    </p><p class="p line">Or With</p>
    </form><a href="google.php"><div class="flex-column" style="max-width: 350px;">
