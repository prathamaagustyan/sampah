...
if( ! isset($_SESSION['username'])){ // Jika tidak ada session username berarti dia belum login
  ...
  if($_GET['nama_sampah'])
  {
    $sampah=$_GET['nama_sampah'];
   $query=mysqli_query($connect,"delete from sampah where nama_sampah='$sampah'");
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <!-- <a href="tambahtarik"><button type="button" class="btn btn-sm btn-outline-success btn-icon-text">
                    ...
                    <div class="col-12">
                      ...
                      <table class="table table-bordered" id="mauexport2" width="100%" cellspacing="0">
                              ...
                              <th>Total Penarikan</th>
                                    ...
                                    <?php 
                                      include "koneksi.php";
                                       $query=mysqli_query($connect,"Select id,tanggal_tarik,username,saldo,tarik from  penarikan where username='$_SESSION[username]'");
                                       $cnt=1;
