...
if( ! isset($_SESSION['username'])){ // Jika tidak ada session username berarti dia belum login
  ...
  if($_GET['action']=='del' && $_GET['rid'])
   {
    $id=intval($_GET['rid']);
    $query=mysqli_query($connect,"update setorkan set status='Sudah di Verifikasi' where id_setor='$id'");
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Data Saldo</p>
                      ...
                      <div class="table-responsive">
                        <table class="table table-bordered" id="mauexport2" width="100%" cellspacing="0">
                          ...
                          <tbody>
                            <?php 
                                      include "koneksi.php";
                                       $query=mysqli_query($connect,"Select id_saldo,tanggal_saldo,username,saldo_keluar,saldo_masuk from  saldo where username='$_SESSION[username]'");
                                       $cnt=1;
                            ...
                            <tr>
                              ...
                              <?php $originalPostingDate = $row['tanggal_saldo'];
$timestamp = strtotime($originalPostingDate);
$formattedDate = date("l, d F Y", $timestamp); ?>
                              <td><?php echo htmlentities($formattedDate);?></td>
                              <td><?php echo htmlentities($row['saldo_keluar']);?></td>
                              <td><?php echo htmlentities($row['saldo_masuk']);?></td>
                            </tr>
                            <?php
                                       $cnt++;
                                        } ?>
