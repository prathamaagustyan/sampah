        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Data Setor</p>
                      ...
                      <div class="table-responsive">
                        <table class="table table-bordered" id="mauexport2" width="100%" cellspacing="0">
                          ...
                          <tbody>
                            <?php 
                                      include "koneksi.php";
                                       $query=mysqli_query($connect,"Select id_setor,tanggal_setor,username,nama_sampah,berat,harga_sampah,total_harga from  setorkan where status='Belum di Verifikasi'");
                                       $cnt=1;
