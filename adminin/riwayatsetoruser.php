                      ...
                      <div class="table-responsive">
                        <table class="table table-bordered" id="mauexport2" width="100%" cellspacing="0">
                          ...
                          <tbody>
                            <?php 
                                      include "koneksi.php";
                                       $query=mysqli_query($connect,"Select id_setor,tanggal_setor,username,nama_sampah,berat,harga_sampah,total_harga,status from  setorkan where status='Sudah di Verifikasi' and username='$_SESSION[username]'");
                                       $cnt=1;
                            ...
                            <tr>
                              ...
                              <?php $originalPostingDate = $row['tanggal_setor'];
